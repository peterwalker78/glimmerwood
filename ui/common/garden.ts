...
import type { DayPart, HomePlant } from "../protocol.gen.js";
...
// ever has.
export function partOfClock(hour: number): DayPart {
...
export function bank(x: number): number {
